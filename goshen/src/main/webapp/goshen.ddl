...
CREATE TABLE BUY_RETURN(
		BUY_RETURN_DT VARCHAR(8),
		BUY_RETURN_SEQ INT,
		BUY_DT VARCHAR(8),
		CUST_NO INT,
		BUY_SEQ INT,
		BUY_RETURN_QUAN DOUBLE,
		UNIT INT
);
...
/* Table Name: 구매교환 */
/**********************************/
CREATE TABLE BUY_CHANGE(
		BUY_CHG_DT VARCHAR(8),
		BUY_CHG_SEQ INT,
		BUY_DT VARCHAR(8),
		CUST_NO INT,
		BUY_SEQ INT,
...
ALTER TABLE BUY ADD CONSTRAINT IDX_BUY_PK PRIMARY KEY (BUY_DT, BUY_SEQ);
ALTER TABLE BUY ADD CONSTRAINT IDX_BUY_FK0 FOREIGN KEY (CUST_NO) REFERENCES CUSTOMER (CUST_NO);
ALTER TABLE BUY ADD CONSTRAINT IDX_BUY_FK1 FOREIGN KEY (PROD_NO) REFERENCES PRODUCT (PROD_NO);
ALTER TABLE BUY ADD CONSTRAINT IDX_BUY_FK2 FOREIGN KEY (UNIT) REFERENCES UNIT (UNIT);

ALTER TABLE INVENTORY ADD CONSTRAINT IDX_INVENTORY_FK0 FOREIGN KEY (PROD_NO) REFERENCES PRODUCT (PROD_NO);

ALTER TABLE BUY_RETURN ADD CONSTRAINT IDX_BUY_RETURN_PK PRIMARY KEY (BUY_RETURN_DT, BUY_RETURN_SEQ);
ALTER TABLE BUY_RETURN ADD CONSTRAINT IDX_BUY_RETURN_FK0 FOREIGN KEY (BUY_DT,BUY_SEQ) REFERENCES BUY (BUY_DT,BUY_SEQ);
ALTER TABLE BUY_RETURN ADD CONSTRAINT IDX_BUY_RETURN_FK1 FOREIGN KEY (UNIT) REFERENCES UNIT (UNIT);

ALTER TABLE BUY_CHANGE ADD CONSTRAINT IDX_BUY_CHANGE_PK PRIMARY KEY (BUY_CHG_DT, BUY_CHG_SEQ);
ALTER TABLE BUY_CHANGE ADD CONSTRAINT IDX_BUY_CHANGE_FK0 FOREIGN KEY (BUY_DT,BUY_SEQ) REFERENCES BUY (BUY_DT,BUY_SEQ);
ALTER TABLE BUY_CHANGE ADD CONSTRAINT IDX_BUY_CHANGE_FK1 FOREIGN KEY (UNIT) REFERENCES UNIT (UNIT);

ALTER TABLE PRODUCT_PRICE ADD CONSTRAINT IDX_PRODUCT_PRICE_PK PRIMARY KEY (CUST_NO, PROD_NO, PROD_SEQ);
ALTER TABLE PRODUCT_PRICE ADD CONSTRAINT IDX_PRODUCT_PRICE_FK0 FOREIGN KEY (PROD_NO) REFERENCES PRODUCT (PROD_NO);

ALTER TABLE RECEIPT ADD CONSTRAINT IDX_RECEIPT_PK PRIMARY KEY (RECEIPT_DT, RECEIPT_TYP, RECEIPT_SEQ);
