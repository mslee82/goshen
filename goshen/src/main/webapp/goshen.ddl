...
ALTER TABLE COM_PRODUCT_PRICE ADD CONSTRAINT IDX_COM_PRODUCT_PRICE_PK PRIMARY KEY (PROD_NO, PROD_SEQ);
ALTER TABLE COM_PRODUCT_PRICE ADD CONSTRAINT IDX_COM_PRODUCT_PRICE_FK0 FOREIGN KEY (PROD_NO) REFERENCES PRODUCT (PROD_NO);

ALTER TABLE BUY_PRODUCT_PRICE ADD CONSTRAINT IDX_BUY_PRODUCT_PRICE_PK PRIMARY KEY (PROD_NO, PROD_SEQ);
