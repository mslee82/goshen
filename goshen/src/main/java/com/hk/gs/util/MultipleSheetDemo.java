...
import com.hk.gs.util.Department;
...
public class MultipleSheetDemo {
    ...
    private static String output = "../multiple_sheet_demo_output.xls";
    ...
    public static void execute() throws IOException {
        ...
        //InputStream is1 = new BufferedInputStream(new FileInputStream(template));
